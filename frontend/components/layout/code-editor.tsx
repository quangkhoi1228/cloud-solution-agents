...
import { CloudSolutionStateType } from '@/stores/types/cloud-solution-state-type';
import { Code, Edit, Eye, File, MoreHorizontal } from 'lucide-react';
...
export function CodeEditor() {
  const { selectedFile, editorTab, setEditorTab, cloudSolutionState } =
    useAppStore();

  // Determine if current file is markdown
  const isMarkdownFile = true;
  const currentContent =
    selectedFile === 'README.md'
      ? readmeContent
      : (cloudSolutionState[
          selectedFile.replace('.md', '') as keyof CloudSolutionStateType
        ] as string);
                ...
                <div className='max-w-5xl mx-auto'>
                  ...
                  <div className='bg-gray-100 rounded-lg p-6 mb-6'>
                    ...
                    <p className='text-gray-700 mb-4'>
                      This is a preview of your React application. The current
                      file{' '}
